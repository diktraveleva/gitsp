...
$HCSET['API_SECRET_KEY'] = 'v15a024f92ec3e4ac893affabfe1f3aba5';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21679937996&js=false&stage='.$HCSET['stage'];
